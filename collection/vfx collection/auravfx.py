...
# VFX_HUB_NAME: cherryblossomaura
# VFX_HUB_DESCRIPTION: cherryblossomaura
# VFX_HUB_CATEGORY: auras
# VFX_HUB_EMITTERS: 1
    "cherryblossomaura" = VfxSystemDefinitionData {
        complexEmitterDefinitionData: list[pointer] = {
            VfxEmitterDefinitionData {
                rate: embed = ValueFloat {
                ...
                texture: string = "ASSETS/vfxhub/Jhin_base_Rose_petals_cherryblossomaura.dds"
                numFrames: u16 = 4
                texDiv: vec2 = { 2, 2 }
            }
        }
        particleName: string = "cherryblossomaura"
        particlePath: string = "cherryblossomaura"
    }
     ...
     "Characters/Aurora/Skins/Skin0/Resources" = ResourceResolver {
        resourceMap: map[hash,link] = {
            ...
            "cherryblossomaura" = "cherryblossomaura"
        }
     }
} 
