...
# VFX_HUB_NAME: testebay
# VFX_HUB_DESCRIPTION: testebay
# VFX_HUB_CATEGORY: buf
# VFX_HUB_EMITTERS: 3
    "testebay" = VfxSystemDefinitionData {
        ...
        complexEmitterDefinitionData: list[pointer] = {
            VfxEmitterDefinitionData {
                ...
                texture: string = "ASSETS/vfxhub/sett_skin45_energy_trail_testassetpath3_testebay.tex"
                birthUvScrollRate: embed = ValueVector2 {
                    constantValue: vec2 = { 1, 0 }
                }
            }
            VfxEmitterDefinitionData {
                ...
                texture: string = "ASSETS/vfxhub/sett_skin45_fire_trail_graphic_testassetpath3_testebay.tex"
                birthUvScrollRate: embed = ValueVector2 {
                    constantValue: vec2 = { 0, -0.5 }
                }
            }
        ...
        particleName: string = "testebay"
        particlePath: string = "testebay"
        flags: u16 = 6
    }
