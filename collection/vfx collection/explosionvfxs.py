...
# VFX_HUB_CATEGORY: explosions
# VFX_HUB_EMITTERS: 11
    "testvfx333" =     "Characters/Aurora/Skins/Skin0/Particles/Aurora_Base_P_SpiritBlue" = VfxSystemDefinitionData {
        complexEmitterDefinitionData: list[pointer] = {
            VfxEmitterDefinitionData {
                rate: embed = ValueFloat {
                    constantValue: f32 = 1
...
# VFX_HUB_NAME: amendtest
# VFX_HUB_DESCRIPTION: amendtest
# VFX_HUB_CATEGORY: explosions
# VFX_HUB_EMITTERS: 16
    "amendtest" =     "Characters/Aurora/Skins/Skin0/Particles/Aurora_Base_Q_Vulnerable_Enemy" = VfxSystemDefinitionData {
        complexEmitterDefinitionData: list[pointer] = {
            VfxEmitterDefinitionData {
                rate: embed = ValueFloat {
                    constantValue: f32 = 1
                ...
                emitterName: string = "Cleaver_Parent"
                isSingleParticle: flag = true
                childParticleSetDefinition: pointer = VfxChildParticleSetDefinitionData {
                    childrenIdentifiers: list[embed] = {
                        VfxChildIdentifier {
                            effectKey: hash = 0x3b3b9feb
                        }
                        VfxChildIdentifier {
                            effectKey: hash = 0x17dca29b
                        }
                        VfxChildIdentifier {
                            effectKey: hash = 0x16dca108
                        }
                    }
            ...
            VfxEmitterDefinitionData {
                ...
                emitterName: string = "OuterBubble"
                disabled: bool = true
                bindWeight: embed = ValueFloat {
                    constantValue: f32 = 1
                }
                ...
                primitive: pointer = VfxPrimitiveMesh {
                    mMesh: embed = VfxMeshDefinitionData {
                        mSimpleMeshName: string = "assets/blablablaaurora/common_magicball.scb"
                    }
                }
                particleColorTexture: string = "ASSETS/vfxhub/amendtest_texture.tex"
                pass: i16 = 100
                colorLookUpTypeY: u8 = 3
                birthRotation0: embed = ValueVector3 {
                ...
                birthScale0: embed = ValueVector3 {
                    constantValue: vec3 = { 5.25, 5.25, 5.25 }
                }
                texture: string = "assets/blablablaaurora/common_relic_shield.tex"
                birthUvScrollRate: embed = ValueVector2 {
            ...
            VfxEmitterDefinitionData {
                ...
                emitterName: string = "TrailingBubble_Mesh"
                disabled: bool = true
                birthDrag: embed = ValueVector3 {
