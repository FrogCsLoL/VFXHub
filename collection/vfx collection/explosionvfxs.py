...
# VFX_HUB_CATEGORY: explosions
# VFX_HUB_EMITTERS: 4
    "testvfx333" =     "Characters/Aurora/Skins/Skin0/Particles/Aurora_Base_BA_Wand" = VfxSystemDefinitionData {
        complexEmitterDefinitionData: list[pointer] = {
            VfxEmitterDefinitionData {
                timeBeforeFirstEmission: f32 = 0.100000001
                rate: embed = ValueFloat {
                ...
                emitterName: string = "BloomOnWeapon1"
                importance: u8 = 2
                bindWeight: embed = ValueFloat {
                    constantValue: f32 = 1
                }
            ...
            VfxEmitterDefinitionData {
                ...
                blendMode: u8 = 4
                birthColor: embed = ValueColor {
                    constantValue: vec4 = { 0.603921592, 0.90196079, 1, 0.970000029 }
                }
                color: embed = ValueColor {
                    dynamics: pointer = VfxAnimatedColorVariableData {
                        times: list[f32] = {
                ...
                texDiv: vec2 = { 2, 1 }
                textureMult: pointer = VfxTextureMultDefinitionData {
                    textureMult: string = "assets/blablablaaurora/aurora_base_comet_trail_01.aurora.tex"
